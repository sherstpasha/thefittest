...
if __name__ == '__main__':
    ...
    model.set_strategy(mutation_opers=[
        'weak_point',
        'average_point',
        'strong_point',
        # 'fitness_based_adaptation_point',
        'weak_grow',
        'average_grow',
        'strong_grow',
        'fitness_based_adaptation_grow',
        # 'fitness_based_adaptation_swap',
        # 'fitness_based_adaptation_shrink',
    ])
    # model.set_strategy(mutation_oper='fitness_based_adatpation_grow')
    model.fit()
