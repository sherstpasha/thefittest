...
def process_problem(problem):
    ...
    crossovers = ["empty", "uniform_1", "uniform_2", "uniform_7", "uniform_prop_2", "uniform_prop_7", "uniform_rank_2", "uniform_rank_7", "uniform_tour_3", "uniform_tour_7"]
...
if __name__ == "__main__":
    results_file = "shaga_conf_problems13.csv"
