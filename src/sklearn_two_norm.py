...
import numpy as np
import cloudpickle
from thefittest.benchmarks import TwoNormDataset  # Используем TwoNormDataset


def run_experiment(run_id, output_dir, model_type, model_params=None):
    data = TwoNormDataset()  # Используем TwoNormDataset
...
if __name__ == "__main__":
    output_dir = r"C:\Users\pasha\OneDrive\Рабочий стол\results2\mlp_lr_rf_svc_adaboost_voting_stacking_gradient_xgboost_two_norm"
