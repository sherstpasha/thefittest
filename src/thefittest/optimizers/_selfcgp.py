...
class SelfCGP(GeneticProgramming):
    ...
    def _selfgp_get_new_individ_g(
        ...
        selected_id = selection_func(fitness_scale, fitness_rank, tour_size, quantity)
    ...
    def set_strategy(
        ...
        crossover_opers: Tuple = ("standart", "one_point", "uniform_rank2"),
        mutation_opers: Tuple = (
            "weak_point",
            "average_point",
            "strong_point",
            "weak_grow",
