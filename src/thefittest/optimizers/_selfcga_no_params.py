...
class SelfCGA(GeneticAlgorithm):
    ...
    def _adapt(self: SelfCGA) -> None:
        if len(self._previous_fitness_i):
            ...
            pdp_crossover_proba = self._get_new_proba_pdp(
                self._crossover_proba, self._crossover_operators, self._thresholds["crossover"]
            )

            pdp_mutation_proba = self._get_new_proba_pdp(
            ...
            selfcea_selection_proba = self._get_new_proba(
            ...
            selfcea_crossover_proba = self._get_new_proba(
            ...
            selfcea_mutation_proba = self._get_new_proba(
            ...
            # print(pdp_mutation_proba)
            # print(selfcea_selection_proba)
            # print(selfcea_crossover_proba)
            # print(selfcea_mutation_proba)
