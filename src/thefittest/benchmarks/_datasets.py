...
class IrisDataset(Dataset):
    ...
    def __init__(self):
        Dataset.__init__(
            ...
            X_names={0: 'sepal length in cm', 1: 'sepal width in cm',
                        2: 'petal length in cm', 3: 'petal width in cm'},
...
class BanknoteDataset(Dataset):
    ...
    def __init__(self):
        Dataset.__init__(
            ...
            X_names={0: 'variance of Wavelet Transformed image (continuous)',
