...
from ..regressors._mlpearegressor_multi_out import fitness_function as evaluate_nets
...
class GeneticProgrammingNeuralNetRegressorMO(GeneticProgrammingNeuralNetClassifier):
    def __init__(
        self,
        iters: int,
        pop_size: int,
