...
def test_GeneticProgramming_set_strategy():
    ...
    initial_population = half_and_half(pop_size=pop_size,
                                       uniset=uniset,
                                       max_level=14)

    optimizer.set_strategy(selection_oper='rank',
...
def test_SelfCGP_set_strategy():
    ...
    optimizer.set_strategy(selection_opers=('tournament_3', 'tournament_k'),
    ...
    selection_set = {'tournament_3': (tournament_selection, 3),
                     'tournament_k': (tournament_selection, 5)}
    crossover_set = {'one_point': (one_point_crossoverGP, 2),
                     'uniformk': (uniform_crossoverGP, 4)}
    mutation_set = {'average_grow': (growing_mutation, 1, True),
    ...
    optimizer.set_strategy(selection_opers=('tournament_5', 'rank'),
    ...
    selection_set = {'tournament_5': (tournament_selection, 5),
                     'rank': (rank_selection, 0)}
    crossover_set = {'uniform2': (uniform_crossoverGP, 2)}
    mutation_set = {'weak_grow': (growing_mutation, 0.25, True),
