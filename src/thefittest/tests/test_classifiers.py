...
def test_GeneticProgrammingNeuralNetClassifier():
    ...
    model = GeneticProgrammingNeuralNetClassifier(
        n_iter=5, pop_size=10, weights_optimizer_args={"iters": 25, "pop_size": 25}
    )
...
def test_MLPEAClassifier():
    ...
    model = MLPEAClassifier(hidden_layers=(0,))
    check_estimator(model)
...
def test_GPClassifier():
    ...
    model = GeneticProgrammingClassifier(n_iter=100, pop_size=100)
