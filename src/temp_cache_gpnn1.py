...
def run_experiment(use_fitness_cache: bool, n_runs: int = 1):
    ...
    for i in range(n_runs):
        ...
        model = GeneticProgrammingNeuralNetClassifier(
            ...
            weights_optimizer_args={"iters": 5000, "pop_size": 50},
...
mean_time_off, std_time_off, mean_score_off, std_score_off = run_experiment(False, n_runs=1)

mean_time_on, std_time_on, mean_score_on, std_score_on = run_experiment(True, n_runs=1)
